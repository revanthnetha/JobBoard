  ...
  return (
    <div className="relative md:w-[542px] md:h-[59px] mt-4 ">
      ...
      <input
        ...
        name={name}
        value={value}
        className="text-[DM Sans] w-full h-full pl-10 pr-4 py-2 ml-2 text-[18px] md:text-[22px] text-gray-700 placeholder-gray-500 bg-[#F4F4F4] border border-gray-300 rounded-[7px]  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
